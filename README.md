...
- Existem três tipos de usuários no sistema:
    ...
    - Administrador - Possui todas as funcionalidades do sistema, inclusive àquelas exclusivas para cliente e vendedores. O usuário Adminstrador, é capaz de cadastrar novos usuários, assim como listá-los e excluí-los.
